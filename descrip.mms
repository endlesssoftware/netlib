...
!   19-NOV-2012 V3.0	Sneddon     VAX support.
!--
...
ALL 	    	: CHECK_VERSION,-
    	    	  $(SRCDIR)NETLIBDEF$(L32),$(BINDIR)NETLIB_GET_VERSION.EXE,$(BINDIR)NETLIB_SHR.EXE
    @ !
...
$(BINDIR)NETLIB_SHR.EXE -
    	    	: $(BINDIR)NETLIB_UCX.OLB($(UCX_MODULES)),-
    	    	  $(BINDIR)NETLIB_COMMON.OLB($(COMMON_MODULES)) $(VEC), $(OPTFILE), $(VERFILE)
    $(LIBR)/COMPRESS/OUTPUT=$(BINDIR)NETLIB_UCX.OLB $(BINDIR)NETLIB_UCX.OLB
    $(LIBR)/COMPRESS/OUTPUT=$(BINDIR)NETLIB_COMMON.OLB $(BINDIR)NETLIB_COMMON.OLB
    $(LINK) $(LINKFLAGS)/SHARE $(VERFILE)/OPT, $(OPTFILE)/OPT, $(BINDIR)NETLIB_UCX.OLB/LIB

$(BINDIR)NETLIB_UCX.OBJ     	: $(SRCDIR)NETLIB.H, $(SRCDIR)NETLIBDEF.H, $(SRCDIR)NETLIB_UCX.H, $(SRCDIR)UCX$INETDEF.H
...
$(ETCDIR)DYNAMIC_SYMBOLS.SDML	    	: $(SRCDIR)GENERATE_SYMBOLS.COM, $(VERFILE)
    @ @GENERATE_SYMBOLS $(VERFILE) $(NUM_VERSION) $(MMS$TARGET)
...
SOURCE_LIST_A	    	    	= $(SRCDIR)DESCRIP.MMS,-
    	    	    	    	  ...
    	    	    	    	  $(SRCDIR)NETLIB_UCX.C, -
    	    	    	    	  $(SRCDIR)NETLIB_UCX.H, $(SRCDIR)UCX$INETDEF.H
