...
$(KITDIR)NETLIB$(NUM_VERSION).B	: $(SRCDIR)ECHOCLIENT.C, $(SRCDIR)ECHOSERVER.C,-
    	    	    	    	  $(SRCDIR)ECHOSERVER_STANDALONE.C,-
				  $(KITDIR)NETLIB_DOC_LIST.DAT,-
				  $(KITDIR)NETLIBDEF_LIST.DAT
...
$(KITDIR)NETLIB_DOC_LIST.DAT : MAKE_NETLIB_DOC_LIST.COM,DOCS
    -@ DELETE/NOLOG $(MMS$TARGET);*
    @MAKE_NETLIB_DOC_LIST

$(KITDIR)NETLIBDEF_LIST.DAT : MAKE_NETLIBDEF_LIST.COM,NETLIBDEF
    -@ DELETE/NOLOG $(MMS$TARGET);*
    @MAKE_NETLIBDEF_LIST
